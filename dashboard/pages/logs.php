...
if ($info['PantherXVer'] == 'X1') {
	...
	$logs['witnesses'] = shell_exec('tac /opt/miner_data/log/console.log | grep -E "miner_onion_server:send_witness|miner_onion_server:decrypt|client sending data|sending witness"');
...
if ($info['PantherXVer'] == 'X2') {
	...
	$logs['witnesses'] = shell_exec('tac /opt/panther-x2/miner_data/log/console.log | grep -E "miner_onion_server:send_witness|miner_onion_server:decrypt|client sending data|sending witness"');
